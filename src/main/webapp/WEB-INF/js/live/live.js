...
function initTable() {
    $('#live_table').bootstrapTable({
        ...
        columns: [{field: 'state', checkbox: true, align: 'center', valign: 'middle'},
            ...
            {field: 'name', title: '直播名称'},
            {field: 'author', title: '直播发起人'},
            {field: 'type', title: '直播类型', sortable: true},
            {field: 'price', title: '直播状态', sortable: true},
            {field: 'startTime', title: '直播开始时间', sortable: true},
            {field: 'overTime', title: '直播结束时间', sortable: true},
...
function operateFormatter(value, row, index) {
    console.log("11");
    return [
        '<a class="like p5"   href="javascript:void(0)" title="Like">预览</a>',
        '<a class="like p5" href="javascript:void(0)" title="Like">推荐</a>',
        '<a class="like p5" href="javascript:void(0)" title="Like">屏蔽</a>',
