...
function initTable() {
    $('#live_table').bootstrapTable({
        ...
        columns: [{field: 'state', checkbox: true, align: 'center', valign: 'middle'},
            ...
            {field: 'class', title: '消息内容'},
            {field: 'name', title: '消息类别',sortable: true},
            {field: 'startTime', title: '推送时间', sortable: true},
            {field: 'overTime', title: '推送人数', sortable: true},
...
function operateFormatter(value, row, index) {
    return [
        ...
        '<a class="Shield p5" href="javascript:void(0)" title="Shield">撤回</a>',
