...
<body class="page-header-fixed">
			...
			<div class="container-fluid">
				...
				<div id="dashboard">
						<div class="portlet-body form">
							<form action="<%=request.getContextPath()%>/syuser/add" class="form-horizontal" method="post">
							...
							<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="password" id="password" class="span6 m-wrap" />
											<span class="help-inline">Some hint here</span>
							           </div>
							...
							<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="phone" id="phone" class="span6 m-wrap" />
											<span class="help-inline">Some hint here</span>
							           </div>
							...
							<div class="form-actions">
										<button id="add" type="button" class="btn blue">Submit</button>
	...
	<script>
		...
		function SysUser(username,password,phone)
		...
		$("#add").click(function(){
	    	...
	    	var user = new SysUser(uname,upassword,uphone);
	    	
	    	var callback = function (data) {
	    		alert(JSON.stringify(data));
	    	};
	    	
	        $.postJSON('<%=request.getContextPath()%>/syuser/add', user, callback);
