			...
			<div class="container-fluid">
				...
				<div id="dashboard">
						<table class="table table-striped table-bordered table-advance table-hover">
							<thead>
										<tr>
										<th><i class="icon-briefcase"></i> roleId</th>
											<th class="hidden-phone"><i class="icon-user"></i>roleName</th>
											<th><i class="icon-shopping-cart"></i> rights</th>
											<th><i class="icon-shopping-cart"></i> parentId</th>
											<th><i class="icon-shopping-cart"></i> addQx</th>
											<th><i class="icon-shopping-cart"></i> delQx</th>
											<th><i class="icon-shopping-cart"></i> editQx</th>
											<th><i class="icon-shopping-cart"></i> chaQx</th>
											<th><i class="icon-shopping-cart"></i> qxId</th>
										</tr>
							</thead>		
							<tbody>	
						        <c:forEach items="${roles}" var="item">
						            <tr><td>${item.roleId}</td><td>${item.roleName}</td><td>${item.rights}</td><td>${item.parentId}</td><td>${item.addQx}</td><td>${item.delQx}</td><td>${item.editQx}</td><td>${item.chaQx}</td><td>${item.qxId}</td></tr>
						        </c:forEach>
						        </tbody>
						     </table>
